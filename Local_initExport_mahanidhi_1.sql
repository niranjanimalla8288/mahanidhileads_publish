...
--
-- Host: localhost    Database: mahanidhi
-- ------------------------------------------------------
...
CREATE TABLE `dbc_blog_meta` (
  ...
  `key` char(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `dbc_categories` (
  ...
  `title` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `fa_icon` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `featured_img` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `dbc_categories` VALUES (1,0,'Real Estate','fa-home','hm.jpg',0,1,1701242746,1),(2,0,'Infra Developers','fa-user','hm1.jpg',0,1,1701246823,1),(3,0,'Groceries','fa-car','hm3.jpg',0,1,1701247639,1),(4,0,'Hospitals','fa-home','PanCard_back.jpeg',0,1,1701685392,1),(5,0,'Children Hospitals','fa-home','TechyTrainEstimates_v1_0.JPG',0,1,1701862339,1),(6,0,'Electronics','fa-home','TechyTrainEstimates_v1_02.JPG',0,1,1702535967,1),(7,0,'Gaming Toys','fa-user','TechyTrainEstimates_v1_04.JPG',0,1,1702639947,1);
...
CREATE TABLE `dbc_customfields` (
  `id` int NOT NULL AUTO_INCREMENT,
  `category_id` int DEFAULT '0',
  `fieldname` char(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `fieldtitle` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `type` char(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `options` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `dbc_emailtmpl` (
  `id` int NOT NULL AUTO_INCREMENT,
  `email_name` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `values` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `status` int NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `dbc_locations` (
  ...
  `name` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `type` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `status` int NOT NULL DEFAULT '1',
  `photo` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `dbc_locations` VALUES (1,0,0,'India','country',1,''),(2,1,1,'telangana','state',1,''),(3,2,1,'Hyderbad','city',1,''),(4,2,1,'Nijamabad','city',1,'');
...
CREATE TABLE `dbc_media` (
  `id` int NOT NULL AUTO_INCREMENT,
  `media_name` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `media_url` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `dbc_messaging` (
  ...
  `last_viewed` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `status` int NOT NULL DEFAULT '1',
...
CREATE TABLE `dbc_offers` (
  ...
  `featured_img` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `dbc_options` (
  `id` int NOT NULL AUTO_INCREMENT,
  `key` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `values` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `status` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `dbc_packages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'post_package',
...
INSERT INTO `dbc_packages` VALUES (1,'featured_package','Free','Free for 15 days',0.00,15,0,5,0),(2,'post_package','Normal','',10.00,60,0,5,0),(3,'post_package','Free','Free for 30 days',0.00,30,0,5,0),(4,'featured_package','Ultimate','Featured for 60 days',5.00,60,0,5,0),(5,'post_package','Gold Business','Watsapp Update, Email, SMS',500.00,60,0,10,0),(6,'post_package','MPL1','My Professional Leads Package 1\r\nTop 5\r\nUnlimited Leads\r\nUnlimited SMS and Mails\r\n5000 Watsapp Notifications ',5000.00,365,0,20,1),(7,'post_package','MPL2','My Professional Leads Package 2\r\nTop 6 to 15\r\n5000 SMS and Mails\r\n3000 Watsapp Notifications ',4000.00,365,0,15,1),(8,'post_package','MPL3','My Professional Leads Package 3\r\nTop 16 to 25\r\n3000 SMS and Mails\r\n2000 Watsapp Notifications ',3000.00,365,0,10,1),(9,'post_package','MPL4','My Professional Leads Package 4\r\nTop 26 to 50\r\n2000 SMS and Mails\r\n1000 Watsapp Notifications ',2000.00,365,0,5,1),(10,'post_package','MPL5','My Professional Leads Package 5\r\nTop 51 and above\r\n1000 SMS and Mails\r\n500 Watsapp Notifications ',1000.00,365,0,3,1);
...
CREATE TABLE `dbc_pages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `alias` char(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `show_in_menu` int NOT NULL DEFAULT '1',
  `layout` int NOT NULL,
  `content_from` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'Manual',
  `title` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `url` char(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sidebar` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `seo_settings` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `create_time` int NOT NULL DEFAULT '0',
  `status` int NOT NULL DEFAULT '1',
...
INSERT INTO `dbc_pages` VALUES (1,'home',1,1,'Url','home','','','','{\"meta_description\":\"classified buy sell. real estates electronics pets vehicles matrimonial jobs community services fashion search and post your ad Top Featured Posts categories\",\"key_words\":\"sale,rent,buy,classified,cms,whiz,electronics,real estate,pets,fashion\",\"crawl_after\":\"3\"}',1424346356,1,0,0),(2,'advanced_search',1,1,'Url','advanced_search','results','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1601976185,1,0,NULL),(3,'about',1,1,'Manual','about','page/about','<h2>About Us:</h2>\r\n<div><div>Mahaanidi is an innovative local search engine designed to revolutionize the way people access information and services within their communities. Unlike global search engines, Mahaanidi focuses on providing hyper-localized results, making it an indispensable tool for residents seeking information that\'s geographically and culturally relevant to them. This platform is particularly beneficial in areas where local businesses, services, and cultural events are not widely covered by larger search engines.</div><div><br></div><div>Built with a deep understanding of local dialects, customs, and preferences, Mahaanidi ensures that users receive results that are not just geographically appropriate, but also culturally aligned. This feature sets it apart in regions where local nuances play a significant role in daily life. The search engine leverages advanced algorithms and machine learning techniques to continuously improve its understanding of local trends, user preferences, and search patterns.</div><div><br></div><div>Mahaanidi also provides a unique platform for local businesses and service providers to reach their target audience more effectively. By prioritizing local businesses in search results, it helps in boosting local economies and supports small and medium-sized enterprises (SMEs) in gaining visibility in their communities.</div><div><br></div><div>Moreover, Mahaanidi is designed with user privacy in mind. It offers robust privacy controls, ensuring that users\' personal data and search histories are protected, making it a trustworthy choice for those concerned about their online privacy.</div><div><br></div><div>In summary, Mahaanidi is more than just a search engine; it\'s a community-centric tool that bridges the gap between local businesses and consumers, fostering a closer, more connected community experience.</div></div>','<div>Phone : +34534223434</div>\r\n<div>Mail : webheliosteam@gmail.com</div>','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1702645750,1,0,NULL),(4,'contact',1,1,'Url','contact','contact','','','{\"meta_description\":\"contact us page for whiz, this meta will be read by search engine\",\"key_words\":\"classified,buy,sale\",\"crawl_after\":\"3\"}',1424339457,1,1,0),(6,'blog',0,0,'Url','blog','blog-posts','<div><br></div>','<div><br></div>','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1702643835,1,1,NULL),(7,'news',1,0,'Url','news','news-posts','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1424339480,1,1,0),(8,'articles',1,0,'Url','articles','article-posts','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1424339485,1,1,0),(9,'pages',0,0,'Url','pages','#','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',2147483647,1,1,0),(10,'list_business',1,0,'Url','list_business','list-business','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1425282749,1,1,0),(11,'locations',1,2,'Url','locations','locations','','','{\"meta_description\":\"city, state, country\",\"key_words\":\"city, state, country\",\"crawl_after\":\"3\"}',2147483647,1,1,0),(12,'terms_and_conditions',1,1,'Manual','terms_and_conditions','page/terms_and_conditions','<h2><b>Terms and Conditions&nbsp;</b></h2><h2><br></h2><h2>Introduction</h2><h2><br></h2><h2>Welcome to Mahaanidhi (\"we,\" \"us,\" or \"our\"). Our website provides local search services to users (\"you\" or \"your\") seeking information and services in specific geographical areas. By accessing or using our website, you agree to be bound by these Terms and Conditions (the \"Terms\").</h2><h2><br></h2><h2>1. Use of the Website</h2><h2><br></h2><h2>1.1. You may use our website only for lawful purposes in accordance with these Terms.</h2><h2>1.2. You agree not to use the website in any way that breaches any applicable local, national, or international law or regulation.</h2><h2><br></h2><h2>2. Content and Services</h2><h2><br></h2><h2>2.1. The content displayed on our website, including listings of local businesses and services, is for general information purposes only.</h2><h2>2.2. We endeavor to keep the information up to date and correct but make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability.</h2><h2><br></h2><h2>3. Intellectual Property Rights</h2><h2><br></h2><h2>3.1. The content, design, layout, and other intellectual property on our website are owned by or licensed to us and are protected by copyright and other intellectual property laws.</h2><h2><br></h2><h2>4. User-Generated Content</h2><h2><br></h2><h2>4.1. Users may post reviews, comments, and other content, as long as the content is not illegal, obscene, threatening, defamatory, invasive of privacy, infringing on intellectual property rights, or otherwise injurious to third parties.</h2><h2><br></h2><h2>5. Privacy</h2><h2><br></h2><h2>5.1. Your use of our website is also governed by our Privacy Policy.</h2><h2><br></h2><h2>6. Limitation of Liability</h2><h2><br></h2><h2>6.1. We will not be liable for any loss or damage arising from your use of, or inability to use, our website or any content on it.</h2><h2><br></h2><h2>7. Changes to These Terms</h2><h2><br></h2><h2>7.1. We reserve the right to make changes to these Terms at any time. Your continued use of the website following changes constitutes your acceptance of the new Terms.</h2><h2><br></h2><h2>8. Governing Law</h2><h2><br></h2><h2>8.1. These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which we are based, without regard to its conflict of law provisions.</h2><h2><br></h2><h2>9. Contact Us</h2><h2><br></h2><h2>9.1. For any questions about these Terms, please contact us at mahaanidhi2023@gmail.com.</h2><h2><br></h2><h2>By using our website, you acknowledge that you have read and understand these Terms and Conditions and agree to be bound by them.</h2>','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1702645680,1,1,NULL),(13,'cookie_policy',0,2,'Manual','cookie_policy','page/cookie_policy','<div class=\"col-md-9\">\n<div class=\"page-sidebar\">\n<p style=\"margin: 0cm 0cm 12pt\"><strong>What are Cookies?</strong><br /> A cookie is a very small piece of information that a website stores to save and collect basic information.<br style=\"box-sizing: border-box\" /> Many cookies are essential to the operation of our website, for example to allow you to make a purchase or create an account with us.<br style=\"box-sizing: border-box\" /> Cookies on our site are also used to customise certain areas of content just for you, and to make your browsing experience more efficient and faster.<br style=\"box-sizing: border-box\" /> <br style=\"box-sizing: border-box\" /> <strong>How we use Cookies</strong><br style=\"box-sizing: border-box\" /> Cookies on our website are used for the following purposes</p>\n<ul style=\"list-style-type: disc\">\n<li style=\"margin-bottom: 3pt\">To enable you to login to the system</li>\n<li style=\"margin-bottom: 3pt box-sizing: border-box background-position: 0px 0.45em\">To enable you to system messages</li>\n<li style=\"margin-bottom: 3pt box-sizing: border-box background-position: 0px 0.45em\">To improve the website\'s usability by saving loading time</li>\n<li style=\"margin-bottom: 3pt box-sizing: border-box background-position: 0px 0.45em\">To analyse the use of our website through Analytics software such as Google Analytics.</li>\n</ul>\n<p></p>\n<p><strong>Information Collected</strong><br style=\"box-sizing: border-box\" /> The cookies our website doesn\'t collect any private data</p>\n</div>\n</div>','','{\"meta_description\":\"cookie policy\",\"key_words\":\"cookie,policy\",\"crawl_after\":\"3\"}',1476443264,1,1,0),(16,'all_offers',1,0,'Url','all_offers','show/all_offers','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1601539391,1,1,NULL),(17,'pricing',1,0,'Url','pricing','pricing','','','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1601980620,1,1,NULL),(18,'termsandconditions',0,0,'Url','Terms and Conditions','termsandconditions','<div><br></div>','<div><br></div>','{\"meta_description\":\"\",\"key_words\":\"\",\"crawl_after\":\"\"}',1702645494,1,1,NULL);
...
CREATE TABLE `dbc_post_package` (
  ...
  `payment_medium` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'paypal',
  `payment_type` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'post',
  `response_log` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`id`),
...
INSERT INTO `dbc_post_package` VALUES (1,'6566f876c3a0f',1,2,10.00,'2023-11-29','2023-11-29','2024-01-28',1,1,'paypal','post','Approved by admin'),(2,'656daa2a0eb9b',2,5,500.00,'2023-12-04','2023-12-04','2024-02-02',1,1,'paypal','post','Approved by admin'),(3,'65705c7f6770c',3,2,10.00,'2023-12-06','2023-12-06','2024-02-04',1,1,'paypal','post','Approved by admin'),(4,'657aa36a71f35',4,2,10.00,'2023-12-14','2023-12-14','2024-02-12',1,1,'paypal','post','Approved by admin'),(5,'657c45b9926d5',5,10,1000.00,'2023-12-15','2023-12-15','2024-12-14',1,1,'paypal','post','Approved by admin'),(6,'657c4778217ef',6,10,1000.00,'2023-12-15',NULL,NULL,2,1,'paypal','post',NULL);
...
CREATE TABLE `dbc_posts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `unique_id` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `title` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `description` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  ...
  `price_range` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `address` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `phone_no` char(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `website` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `founded` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `email` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `featured_img` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `video_url` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `gallery` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `opening_hour` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `additional_features` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `food_menu` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `created_by` int NOT NULL,
  `create_time` int NOT NULL DEFAULT '0',
  `publish_time` int NOT NULL DEFAULT '0',
  `last_update_time` int DEFAULT NULL,
  ...
  `search_meta` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_id` (`unique_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dbc_posts` VALUES (1,'6566f876a895e','{\"en\":\"Top Infra Company\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','{\"en\":\"Top Infra Company \",\"ar\":\" \",\"pt\":\" \",\"es\":\" \"}','infra, developers, real estae\r\n',0.0,'[\"1\"]','[\"1\"]','100-200','{\"en\":\"Suraram colony\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','12545622','http://kittuhomlands.com','1990','niranjan.exp@gmail.com',1,2,3,'500006',17.45099870,78.48833801,'hm2.jpg',NULL,NULL,NULL,NULL,NULL,1,1701247094,1701247094,1701247279,1,'2023-11-29','2024-01-28',0,'2023-12-09',0,43,'Real Estate Real Estate 1990 India telangana Hyderbad 500006 Top Infra Company Suraram colony       infra, developers, real estae\r\n '),(2,'656daa29e8653','{\"en\":\"Lenus Hospitals\",\"ar\":\"Lenus Hospitals\",\"pt\":\"Lenus Hospitals\",\"es\":\"Lenus Hospitals\"}','{\"en\":\"Nice description about Lenus Hospitals \",\"ar\":\" \",\"pt\":\" \",\"es\":\" \"}','good hospial, top children hospital, best child care',0.0,'[\"4\"]','[\"4\"]','20-100','{\"en\":\"345., Snjejvaredy Naar\",\"ar\":\"345., Snjejvaredy Naar\",\"pt\":\"345., Snjejvaredy Naar\",\"es\":\"345., Snjejvaredy Naar\"}','1234512315','www.abc.om','2022','niranjan.exp@gmail.com',1,2,3,'500038',17.69000000,78.56000000,'PanCard_back1.jpeg','','[\"novelski_logo.jpg\",\"novelski_logo.jpg\"]','[{\"day\":\"monday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"tuesday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"wednesday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"thursday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"friday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"saturday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"},{\"day\":\"sunday\",\"closed\":0,\"start_time\":\"09:00 AM\",\"close_time\":\"05:00 PM\"}]','[]',NULL,1,1701685801,1701685801,1701688595,1,'2023-12-04','2024-02-02',0,NULL,0,12,'Hospitals Hospitals 2022 India telangana Hyderbad 500038 Lenus Hospitals 345., Snjejvaredy Naar Lenus Hospitals 345., Snjejvaredy Naar Lenus Hospitals 345., Snjejvaredy Naar Lenus Hospitals 345., Snjejvaredy Naar good hospial, top children hospital, best child care '),(3,'65705c7f4cb0c','{\"en\":\"Good Life Child Care\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','{\"en\":\"Good Life Child Care \",\"ar\":\" \",\"pt\":\" \",\"es\":\" \"}','good child care, top children',0.0,'[\"5\"]','[\"5\"]','100-200','{\"en\":\"2345h\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','1234512345','www.xyz.com','2012','niranjan.exp@gmail.com',1,2,3,'500023',17.63000000,78.63000000,'TechyTrainEstimates_v1_01.JPG',NULL,NULL,NULL,NULL,NULL,1,1701862527,1701862527,1701862618,1,'2023-12-06','2024-02-04',0,NULL,0,14,'Children Hospitals Children Hospitals 2012 India telangana Hyderbad 500023 Good Life Child Care 2345h       good child care, top children '),(4,'657aa36a59ee6','{\"en\":\"Bajaj Electronics\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','{\"en\":\"Bajaj Electronics \",\"ar\":\" \",\"pt\":\" \",\"es\":\" \"}','electronics, super electronics, cheap elctrnics',0.0,'[\"6\"]','[\"6\"]','100-200','{\"en\":\"2345h\",\"ar\":\"\",\"pt\":\"\",\"es\":\"\"}','1234512345','www.xyz.com','2012','niranjan.exp@gmail.com',1,2,4,'500023',17.63000000,78.63000000,'TechyTrainEstimates_v1_03.JPG',NULL,NULL,NULL,NULL,NULL,1,1702536042,1702536042,1702536061,1,'2023-12-14','2024-02-12',0,NULL,0,4,'Electronics Electronics 2012 India telangana Nijamabad 500023 Bajaj Electronics 2345h       electronics, super electronics, cheap elctrnics '),(5,'657c45b9776d7','{\"en\":\"Some Good Toy Company\"}','{\"en\":\"<div>Some Good Toy Company<br><\\/div>\"}','Toys, Games, Children Toys, China Toys',0.0,'[\"7\"]','[\"7\"]','100-200','{\"en\":\"2345h\"}','1234512345','www.xyz.com','2012','sometoys@gmail.com',1,2,3,'500023',17.63000000,78.63000000,'default_large.png',NULL,NULL,NULL,NULL,NULL,1,1702643129,1702643129,1702643608,1,'2023-12-15','2024-12-14',0,NULL,0,0,'Gaming Toys Gaming Toys 2012 India telangana Hyderbad 500023 Some Good Toy Company 2345h Toys, Games, Children Toys, China Toys '),(6,'657c477807289','{\"en\":\"Some Good Toy Company\"}','{\"en\":\"&lt;div&gt;Some Good Toy Company&lt;br&gt;&lt;\\/div&gt;\"}','Some Good Toy Company',0.0,'[\"1\"]','[\"1\"]','100-200','{\"en\":\"2345h\"}','1234512345','www.xyz.com','2012','niranjan.exp@gmail.com',1,2,3,'500023',17.63000000,78.63000000,'',NULL,NULL,NULL,NULL,NULL,1,1702643576,1702643576,1702643576,3,NULL,NULL,0,NULL,0,0,'Real Estate Real Estate 2012 India telangana Hyderbad 500023 Some Good Toy Company 2345h Some Good Toy Company ');
...
CREATE TABLE `dbc_slider` (
  ...
  `featured_img` char(200) NOT NULL,
  `title` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `description` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `created_by` int NOT NULL,
  `create_time` int NOT NULL,
  `status` int NOT NULL DEFAULT '1',
...
CREATE TABLE `dbc_urlmetas` (
  ...
  `custom_url` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `meta_tags` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `dbc_urlmetas` VALUES (1,'en/ads/54f5a06e62f7a/Indian-Food','indian-food-restaurant','','Yes',1,1600766658,1),(2,'en/show/categoryposts/4/real_estate','real-estates-near-you','','Yes',1,1600771071,1);
...
CREATE TABLE `dbc_user_meta` (
  ...
  `key` char(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `value` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `status` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `dbc_user_meta` VALUES (1,2,'company_name','rani.com',1),(2,2,'phone','893646443',1),(3,3,'company_name','',1),(4,3,'phone','',1),(5,1,'company_name','Mahanidhi Leads',1),(6,1,'phone','',1),(7,1,'about_me','Is ',1),(8,1,'fb_profile','',1),(9,1,'twitter_profile','',1),(10,1,'li_profile','',1),(11,1,'gp_profile','',1),(12,1,'hide_email',NULL,1),(13,1,'hide_phone',NULL,1);
...
CREATE TABLE `dbc_users` (
  ...
  `first_name` char(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `last_name` char(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `gender` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `profile_photo` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `user_name` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `user_email` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `password` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `remember_me_key` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `dbc_widgets` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `alias` char(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
